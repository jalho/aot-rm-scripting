/* this is a sandbox script for trying things out, consisting originally of rmx 5-0-0.xs and alfheim 5-0-0.xs */
...
void injectBuildChecksumMsg() {
	...
	code("trChatSend(0, \"<color=0.0,0.5,0.6>Build checksum: a415e6cbc20879a0bbca2949e3af05da500dafbb.</color>\");");
...
void main() {
	...
	// Straggler cyclops.
	int stragglerCyclopsID = rmCreateObjectDef("straggler cyclops");
	rmAddObjectDefItem(stragglerCyclopsID, "cyclops", 1, 0.0);
	setObjectDefDistance(stragglerCyclopsID, 13.0, 14.0);
	rmAddObjectDefConstraint(stragglerCyclopsID, avoidAll);
	...
	// Straggler trees.
	placeObjectAtPlayerLocs(stragglerTreeID, false, rmRandInt(1, 3));

  // Straggler cyclops.
	placeObjectAtPlayerLocs(stragglerCyclopsID, false, 3);
